...
export const metadata: Metadata = { title: "Ustawienia serwera" };
...
export default async function ServerSettingsPage() {
  ...
  return <AuthenticatedPanelShell session={session} active="server-settings">
    <header className="role-panel-heading owner-heading">
      <div><span className="section-kicker">Konto obsługi systemu</span><h1>Ustawienia serwera</h1><p>Poczta, SMS, kopie, zewnętrzny dysk i diagnostyka Raspberry w jednym miejscu.</p></div>
