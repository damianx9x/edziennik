...
import { isTransactionalEmailConfigured, maskEmail } from "@/modules/bootstrap/security";

export const metadata: Metadata = { title: "Pierwsze uruchomienie" };
  ...
  return (
    <main className="auth-page first-run-page">
      <div className="auth-topbar">
        <Brand compact />
        <span className="first-run-private"><ShieldCheck aria-hidden="true" /> Prywatna konfiguracja</span>
      </div>
      <div className="security-setup-page first-run-layout">
        <section className="security-setup-intro">
          ...
          <p>
            Baza nie zawiera uczniów, rodziców, grup ani danych demonstracyjnych.
            Najpierw zabezpieczymy jedyne konto administracji technicznej.
          </p>
