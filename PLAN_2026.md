...
**Stan: w realizacji na gałęzi `stage/3-schedule-diary`. Pierwszy odbiór
obejmuje grafik ręczny, Asystenta i widoki ról. Temat lekcji oraz szybka
obecność są gotowe do testu; cykliczność pozostaje kolejnym fragmentem tego
samego etapu.**
