...
def role_function(
    ...
    story += [
        ...
        *bullets(problems),
        callout("Dobra praktyka", tip, "gold"),
        PageBreak(),
    ]
    return story
...
def director_functions():
    return [
        ...
        manual_entry("Zaproszenia, konta i reset dostępu", "Dyrektor tworzy konta przez zaproszenia, określa rolę i może bezpiecznie rozpocząć reset hasła.", "Menu → Zaproszenia i konta", "kartoteki.png", ["sprawdź poprawny e-mail i rolę osoby", "dla rodzica najpierw utwórz lub odnajdź dziecko"], ["Wybierz „Zaproś osobę”.", "Podaj imię, e-mail, rolę i czas ważności zaproszenia.", "Ustal, czy kod działa jeden raz, określoną liczbę razy czy do wygaśnięcia.", "Wyślij zaproszenie i sprawdź jego status na liście.", "Jeżeli osoba utraci hasło, otwórz jej konto i wybierz bezpieczny reset; system wysyła link zamiast pokazywać hasło."], "Zaproszona osoba sama ustawia hasło. Każde utworzenie, ponowienie i reset zostają zapisane w audycie.", ["zapraszać role szkoły", "unieważniać niewykorzystane zaproszenia", "wymusić reset hasła zwykłego konta"], ["poznać aktualne hasło", "resetować konto właściciela systemu", "nadawać roli przez samą zmianę tekstu w kartotece"], ["pusta poczta: sprawdź SMTP i kolejkę e-mail", "adres istnieje: odnajdź konto zamiast tworzyć drugie", "zaproszenie wygasło: utwórz nowe"], "Nie przesyłaj hasła przez wiadomość. Użytkownik zawsze ustawia je sam przez jednorazowy link."),
