...
Produkcja: **1.1.5**, commit 6973fb7 — statystyki właściciela, usunięcie bounty i blokady napięcia wdrożone. Zmiana ról i panel rodzica pozostają dostępne. Pełny zakres i stan w `docs/HOTFIX_2026-09-12.md`.
